...
import 'package:final_project/component/textfield.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Logindriver(context) async
  {
    ...
    if(firebaseUser != null)
    {
      ...
      Navigator.push(
        context  ,
        MaterialPageRoute(builder: (c) => (ChoicePage())),
        //MaterialPageRoute(builder: (c) => (DriverHomePage())),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Share your ride with your colleague',
                  style: TextStyle(
